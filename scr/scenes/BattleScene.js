...
export class BattleScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Bouton de gestion de la vitesse
    ...
    // Zone de texte pour les logs (12 lignes max affichées)
    ...
    // Affichage des cartes (décalé à gauche pour laisser la place à l'historique)
    this.renderTeam(this.playerTeam, 80, 450);
    this.renderTeam(this.enemyTeam, 120, 150);

    // Message d'action centrale en bas
