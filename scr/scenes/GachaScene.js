...
export class GachaScene extends Phaser.Scene {
  ...
  drawSummon() {
    if (PLAYER_DATA.gold < 100) { this.logText.setText('Pas assez d\'or !'); return; }
    PLAYER_DATA.gold -= 100;
    const drawnKey = Phaser.Utils.Array.GetRandom(Object.keys(UNITS_DATABASE));
    ...
    this.tweens.add({
      targets: this.cardDisplay, scaleX: 0, duration: 150, yoyo: true,
      onYoyo: () => {
