export const SUMMON_POOL_DATABASE = {
  ...
  squelette: {
    ...
    color: 0x888888, rarity: 'N', element: 'tenebres',
  ...
  rat_geant: {
    ...
    color: 0x5a4a3a, rarity: 'N', element: 'nature',
  ...
  gobelin: {
    ...
    color: 0x3d6b2b, rarity: 'N', element: 'nature',
  ...
  loup_gris: {
    ...
    color: 0x6d6d6d, rarity: 'N', element: 'nature',
  ...
  zombie: {
    ...
    color: 0x4a5a3a, rarity: 'N', element: 'tenebres',
  ...
  bandit: {
    ...
    color: 0x704214, rarity: 'N', element: 'nature',
  ...
  araignee_venin: {
    ...
    color: 0x2b1a3a, rarity: 'N', element: 'nature',
  ...
  chauve_souris_vampire: {
    ...
    color: 0x3a1a3a, rarity: 'N', element: 'tenebres',
  ...
  limace_acide: {
    ...
    color: 0x6bbf3a, rarity: 'N', element: 'eau',
  ...
  corbeau_maudit: {
    ...
    color: 0x1a1a1a, rarity: 'N', element: 'tenebres',
  ...
  sanglier_sauvage: {
    ...
    color: 0x4a2a1a, rarity: 'N', element: 'feu',
  ...
  brigand: {
    ...
    color: 0x8a5a2a, rarity: 'N', element: 'nature',
  ...
  slime: {
    ...
    color: 0x3aa8bf, rarity: 'N', element: 'eau',
  ...
  hyene_des_sables: {
    ...
    color: 0xc2a15c, rarity: 'N', element: 'feu',
  ...
  serpent_crache: {
    ...
    color: 0x2a7a2a, rarity: 'N', element: 'eau',
  ...
  moine_dechu: {
    ...
    color: 0x5a3a1a, rarity: 'N', element: 'tenebres',
  ...
  esprit_frappeur: {
    ...
    color: 0x9a9aff, rarity: 'N', element: 'tenebres',
  ...
  spectre_glacial: {
    ...
    color: 0x6ab8e0, rarity: 'R', element: 'eau',
  ...
  golem_pierre: {
    ...
    color: 0x7a7a6a, rarity: 'R', element: 'sacre',
  ...
  harpie: {
    ...
    color: 0xb08a3a, rarity: 'R', element: 'nature',
  ...
  chevalier_rouille: {
    ...
    color: 0x8a4a2a, rarity: 'R', element: 'tenebres',
  ...
  sorciere_bois: {
    ...
    color: 0x2a5a2a, rarity: 'R', element: 'nature',
  ...
  troll_marais: {
    ...
    color: 0x4a5a3a, rarity: 'R', element: 'eau',
  ...
  gargouille: {
    ...
    color: 0x5a5a5a, rarity: 'R', element: 'eau',
  ...
  assassin_ombre: {
    ...
    color: 0x1a1a2a, rarity: 'R', element: 'tenebres',
  ...
  cyclope: {
    ...
    color: 0x8a6a3a, rarity: 'R', element: 'feu',
  ...
  minotaure_jeune: {
    ...
    color: 0x6b3a1a, rarity: 'R', element: 'feu',
  ...
  banshee: {
    ...
    color: 0xc0c0e0, rarity: 'R', element: 'eau',
  ...
  centaure_guerrier: {
    ...
    color: 0x7a5a3a, rarity: 'R', element: 'feu',
  ...
  golem_obsidienne: {
    ...
    color: 0x1a1a1a, rarity: 'SR', element: 'tenebres',
  ...
  liche_mineure: {
    ...
    color: 0x2a6a4a, rarity: 'SR', element: 'tenebres',
  ...
  chimere: {
    ...
    color: 0x8a3a3a, rarity: 'SR', element: 'nature',
  ...
  seraphin_dechu: {
    ...
    color: 0x3a1a4a, rarity: 'SR', element: 'tenebres',
  ...
  hydre_jeune: {
    ...
    color: 0x2a6a2a, rarity: 'SR', element: 'eau',
  ...
  demon_flamme: {
    ...
    color: 0xcc4400, rarity: 'SR', element: 'feu',
  ...
  reine_araignee: {
    ...
    color: 0x4a1a5a, rarity: 'SR', element: 'nature',
  ...
  wyverne: {
    ...
    color: 0x3a6a8a, rarity: 'SR', element: 'nature',
    skill: { name: 'Piqué Venimeux', chance: 0.3, type: 'damage_single', multiplier: 2.0 }
  },
  lapin_pyromane: {
    name: 'Lapin Pyromane', hp: 950, maxHp: 950, atk: 250, def: 120, agi: 175, wis: 105,
    color: 0xff5500, rarity: 'SR', element: 'feu',
    skill: { name: 'Carotte Explosive', chance: 0.35, type: 'damage_single', multiplier: 1.95 }
  },
  ...
  dragon_ombre: {
    ...
    color: 0x1a0a2a, rarity: 'SSR', element: 'tenebres',
  ...
  archange_noir: {
    ...
    color: 0x0a0a1a, rarity: 'SSR', element: 'tenebres',
  ...
  titan_abysses: {
    ...
    color: 0x0a2a3a, rarity: 'SSR', element: 'eau',
  ...
  reine_liches: {
    ...
    color: 0x2a0a3a, rarity: 'SSR', element: 'tenebres',
    skill: { name: 'Résurrection Noire', chance: 0.4, type: 'heal_team', power: 400 }
  },
  chat_des_abysses: {
    name: 'Chat des Abysses', hp: 1320, maxHp: 1320, atk: 285, def: 185, agi: 220, wis: 190,
    color: 0x005588, rarity: 'SSR', element: 'eau',
    skill: { name: 'Griffe Glaciale', chance: 0.35, type: 'damage_single', multiplier: 2.1 }
  },
  chien_sylvestre: {
    name: 'Chien Sylvestre', hp: 1420, maxHp: 1420, atk: 295, def: 210, agi: 190, wis: 170,
    color: 0x228833, rarity: 'SSR', element: 'nature',
    skill: { name: 'Hurlement Verdoyant', chance: 0.3, type: 'heal_team', power: 380 }
  },
  ...
  phenix_immortel: {
    ...
    color: 0xff6600, rarity: 'UR', element: 'feu',
  ...
  leviathan_abyssal: {
    ...
    color: 0x003355, rarity: 'UR', element: 'eau',
  ...
  empereur_dechu: {
    ...
    color: 0x330011, rarity: 'UR', element: 'tenebres',
    skill: { name: 'Édit de Destruction', chance: 0.4, type: 'damage_single', multiplier: 2.5 }
  },
  cheval_sacre: {
    name: 'Cheval Céleste', hp: 1850, maxHp: 1850, atk: 350, def: 250, agi: 280, wis: 270,
    color: 0xffd700, rarity: 'UR', element: 'sacre',
    skill: { name: 'Charge Divine', chance: 0.35, type: 'damage_single', multiplier: 2.3 }
  },
  ...
  loup_affame: {
    ...
    color: 0x555555, rarity: 'N', element: 'nature',
  ...
  rat_corrompu: {
    ...
    color: 0x4a3a2a, rarity: 'N', element: 'tenebres',
  ...
  zombie_enrage: {
    ...
    color: 0x4a5a2a, rarity: 'R', element: 'tenebres',
  ...
  brigand_cagoule: {
    ...
    color: 0x333333, rarity: 'R', element: 'nature',
  ...
  araignee_geante: {
    ...
    color: 0x2a1a3a, rarity: 'R', element: 'nature',
  ...
  golem_fissure: {
    ...
    color: 0x6a6a5a, rarity: 'SR', element: 'nature',
  ...
  harpie_sanglante: {
    ...
    color: 0x9a2a2a, rarity: 'SR', element: 'tenebres',
  ...
  ombre_rampante: {
    ...
    color: 0x1a1a2a, rarity: 'SR', element: 'tenebres',
  ...
  spectre_vengeur: {
    ...
    color: 0x5a7a9a, rarity: 'SR', element: 'tenebres',
  ...
  troll_cavernes: {
    ...
    color: 0x4a5a3a, rarity: 'SR', element: 'eau',
  ...
  cyclope_furieux: {
    ...
    color: 0x7a5a2a, rarity: 'SR', element: 'feu',
  ...
  demon_mineur: {
    ...
    color: 0x8a1a1a, rarity: 'SSR', element: 'feu',
  ...
  liche_novice: {
    ...
    color: 0x2a6a5a, rarity: 'SSR', element: 'tenebres',
  ...
  gargouille_jade: {
    ...
    color: 0x2a8a5a, rarity: 'SSR', element: 'sacre',
  ...
  chevalier_dechu: {
    ...
    color: 0x3a1a1a, rarity: 'SSR', element: 'tenebres',
  ...
  hydre_bicephale: {
    ...
    color: 0x1a5a3a, rarity: 'SSR', element: 'eau',
  ...
  vouivre_ecarlate: {
    ...
    color: 0xaa1a2a, rarity: 'SSR', element: 'feu',
  ...
  gardien_foret: {
    ...
    color: 0x114411, rarity: 'SR', element: 'sacre',
